                      ...
                      <div class="row m-l-0 m-r-0">
                          <div class="col-sm-8">
                              <div class="card-block">
                                  <h6 class="m-b-20 p-b-5 b-b-default f-w-600">Profil Saya</h6>
                                  <div class="row">
                                      <div class="col-sm-6">
                                          <p class="m-b-10 f-w-600">Nama Lengkap</p>
                                          <h6 class="text-muted f-w-400">Ariana Grande</h6>
                                      </div>
                                      <div class="col-sm-1">
                                        <p class="m-b-10 f-w-600">Email</p>
                                        <h6 class="text-muted f-w-400">reservasi_yuk@gmail.com</h6>
                                      </div>
                                      <div class="col-sm-6">
                                          <p class="m-b-10 f-w-600">Telepon</p>
                                          <h6 class="text-muted f-w-400">081122334455</h6>
                                      </div>
                                      <div class="col-sm-1">
                                        <p class="m-b-10 f-w-600">Tanggal Lahir</p>
                                        <h6 class="text-muted f-w-400">26/06/1993</h6>
                                      </div>
                                      <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">Jenis Kelamin</p>
                                            <h6 class="text-muted f-w-400">Perempuan</h6>
                                       </div>
                                  </div>
                                  <a class="nav-link scrollto" href="ubahprofil.html"><button>Ubah Profil</button></a>
                                  <a class="nav-link scrollto" href="ubahkatasandi.html"><button>Ubah Kata Sandi</button></a>
